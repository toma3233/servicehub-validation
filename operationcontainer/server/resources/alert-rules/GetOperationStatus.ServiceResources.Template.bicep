...
module qpsAlertRule 'br/public:avm/res/insights/scheduled-query-rule:0.1.2' = {
  name: 'operationcontainer-GetOperationStatus-query-per-second'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    name: 'operationcontainer-GetOperationStatus-query-per-second'
    location: location
...
module errorRatioAlertRule 'br/public:avm/res/insights/scheduled-query-rule:0.1.2' = {
  name: 'operationcontainer-GetOperationStatus-error-ratio'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    name: 'operationcontainer-GetOperationStatus-error-ratio'
    location: location
...
module latencyAlertRule 'br/public:avm/res/insights/scheduled-query-rule:0.1.2' = {
  name: 'operationcontainer-GetOperationStatus-latency-by-error-code'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    name: 'operationcontainer-GetOperationStatus-latency-by-error-code'
    location: location
