...
module errorRatioAlertRule 'br/public:avm/res/insights/scheduled-query-rule:0.1.2' = {
  name: 'operationcontainer-CreateOperationStatus-error-ratio'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    name: 'operationcontainer-CreateOperationStatus-error-ratio'
    location: location
    alertDescription: 'This is the alert for operationcontainer for the calculated metric error ratio.'
    criterias: {
      allOf: [
        {
...
module latencyAlertRule 'br/public:avm/res/insights/scheduled-query-rule:0.1.2' = {
  name: 'operationcontainer-CreateOperationStatus-latency-by-error-code'
  scope: resourceGroup(subscriptionId, resourceGroupName)
  params: {
    name: 'operationcontainer-CreateOperationStatus-latency-by-error-code'
    location: location
