...
require (
	dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/mygreeterv3/api v0.0.64
	github.com/Azure/OperationContainer/api v0.0.12
	github.com/Azure/aks-async v0.0.40
	...
	github.com/microsoft/go-otel-audit v0.2.0
...
require (
	...
	buf.build/gen/go/service-hub/loggable/protocolbuffers/go v1.32.0-20231012175355-a349f6324a7e.1 // indirect
