...
// Source: dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/mygreeterv3/api/v1 (interfaces: MyGreeterClient)
//
// Generated by this command:
//
//	mockgen -package mock dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/mygreeterv3/api/v1 MyGreeterClient
//
...
import (
	...
	v1 "dev.azure.com/service-hub-flg/service_hub_validation/_git/service_hub_validation_service.git/mygreeterv3/api/v1"
...
func (m *MockMyGreeterClient) CancelOperation(ctx context.Context, in *v1.CancelOperationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
...
func (mr *MockMyGreeterClientMockRecorder) CancelOperation(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CancelOperation", reflect.TypeOf((*MockMyGreeterClient)(nil).CancelOperation), varargs...)
}
