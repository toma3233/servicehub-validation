...
namespace Microsoft.CsharpUserRp.Service
{
    /// <summary>
    ...
    public class VersionedSerializer : VersionedSerializerBase<VersionedContractResolver>
    {
        ...
        {
            ServiceVersions = new CsharpUserRpServiceVersions();
            ServiceVersionComparer = new VersionComparer(new CsharpUserRpServiceVersions());
        }
